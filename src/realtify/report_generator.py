...
# Ширина скрина аналога — майже повна ширина тексту (A4 ≈6.5"), але під порогом
# валідатора стабільної пагінації (max 6.35"): 6.3" = 5 760 720 EMU.
_PAGE_TEXT_WIDTH_EMU = 5_760_720
